  ...
  return (
    <Container className="py-20">
      <div className="mx-auto mb-12 max-w-[640px] text-center">
        <span className="eyebrow">Simple, flat pricing</span>
        <h1 className="mt-3 font-serif text-[clamp(32px,4.4vw,48px)]">One price. No credits. No surprises.</h1>
        <p className="mt-4 text-lg text-ink-2">
          Pay a flat monthly rate and verify your lists — emails and phones included. Cancel anytime.
        </p>
      </div>
      ...
      <div className="grid items-stretch gap-5 md:grid-cols-2 lg:grid-cols-4">
        {PLANS.map((plan) => (
          <div
            key={plan.id}
            className={cn(
              "relative flex flex-col rounded-lg border bg-raised p-7 shadow-s1",
          ...
          >
            ...
            {plan.id === "free" ? (
              <Button href="/signup" variant="ghost" className="mt-auto w-full">
                Start free
              </Button>
            ) : (
              <CheckoutButton
